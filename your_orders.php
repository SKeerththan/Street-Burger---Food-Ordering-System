											...
											?>
													<tr>
														...
														<td data-column="status">
															...
															?>
																<button type="button" class="btn btn-info"><span class="fa fa-bars" aria-hidden="true"></span> Ordered</button>
															<?php
															}
														...
														<td data-column="Action">
															...
															if ($status == "" or $status == "NULL") {
															?>
																<a href="delete_orders.php?order_del=<?php echo $row['o_id']; ?>" onclick="return confirm('Are you sure you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"> </i> Click to Cancel</a>
															<?php
															}
															if ($status == "in process") { ?>

																<!-- <a href="#" onclick="return alert('They are preparing your order. Unable to cancel while preparing.');" class="btn btn-warning btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-cog fa-spin" style="font-size:16px"></i> Please Wait . . .</a> -->
