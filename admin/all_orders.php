                        ...
                        <div class="col-lg-12">
                            <div class="card  ">
                                <div class="card-header" style="background-color: orange;">
                                    <div class="row">
                                        <div class="col">
                                            <button type="submit" class="btn btn-light" onclick="window.print();" name="btnPdfOrders" class="fa fa-bars"> <i class="fa fa-solid fa-print"></i> &nbsp Print All Orders</button>
                                        </div>
                                    </div>
                                </div>
