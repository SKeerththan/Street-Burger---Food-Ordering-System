                        ...
                        <div class="col-lg-12">
                            <div class="card  ">
                                <div class="card-header" style="background-color: orange;">
                                    <div class="row">
                                        <div class="col">
                                            <button type="submit" class="btn btn-light" onclick="window.print();" name="btnPdfOrders" class="fa fa-bars"> <i class="fa fa-solid fa-print"></i> &nbsp Print All Menus</button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo '<tr><td>' . $fetch['title'] . '</td>
																								...
																								<center><img src="Res_img/dishes/' . $rows['img'] . '" class="  radius"  style="max-height:90px;max-width:110px;"/></center>
																								</div></td>
