...
// echo $_GET['user_id'], $_GET['password'], $_GET['token'];
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Welcome!</h1> <img src="images/Logo.jpg" width=" 125" height="120" style="display: block; border: 0px;" />
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                            ...
                                            <tr>
                                                ...
                                                Confirm Account</a> -->
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        $sql = "select * from `users` where username='" . $_GET['user_id'] . "' AND password ='" . $_GET['password'] . "' and status='2' and token='" . $_GET['token'] . " '";
                                                        $activation = mysqli_query($db, $sql);
                                                        if (mysqli_num_rows($activation) > 0) {
                                                            echo " <input type='submit' value='Confirm your account' name='active' class='btn btn-outline-warning'>";
                                                        } else {
                                                            echo " <input type='submit' value='Verification Link Expired' name='active' class='btn btn-warning'>";
                                                        }
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;">Cheers,<br>Street Burger Team</p>
                        </td>
                    </tr>
                </table>
            </td>
